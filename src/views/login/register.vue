<template>
  <div class="register-page" v-wechat-title="$route.meta.title" img-set="./static/img/favicon.ico">
    <div class="content">
      <div class="logo">
      ...
      <div class="buttom-box">
        <span @click="register" :class="{disableC:!codeMessage||!moblie||!password}">注册</span>
      </div>
      <div class="reset-register">
        <span @click="tapToOther('/loginBypassword')">已注册，去登录</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    timeStart() {
      ...
      this.$common.sendMesForReg("", 2, this.moblie).then(e => {
        if (e) {
          if (!_this.timer) {
